    ...
    items: [
      {
        name: "SubHunt",
        summary:
          "Privacy-first subscription tracker for Android that helps users monitor recurring payments without any bank linking or cloud sync. All data stays on the device. Built with Kotlin, Jetpack Compose, Material 3, Hilt, Room, WorkManager. RevenueCat KMP integrated (billing module present but paywall disabled — all features included free and open source).",
        ...
        stack: [
          ...
          "Room",
          "WorkManager",
          "RevenueCat KMP (billing present, not enforced)",
      ...
      },
      {
        ...
        stack: [
          ...
          "PostgreSQL (Supabase)",
          "NextAuth v5",
          "Stripe (integration present, billing disabled)",
      ...
      },
      {
        name: "SS Mart ERP",
        summary:
          "Complete retail ERP/POS system with Flutter mobile/desktop client, .NET 8 backend API, and PostgreSQL database. Offline-first architecture with background synchronization — designed for Indian retail operations with GST, HSN/SAC, and B2B/B2C support.",
