export const portfolio = {
  ...
  headline:
    "Frontend and full-stack developer building production-grade applications.",
  supportingCopy:
    "I'm Manideep Daram, a software engineer based in Hyderabad. I specialize in building reliable web applications with TypeScript, React, Node.js, and cloud infrastructure. My focus is on clean code, proper documentation, and shipping work that's easy for others to maintain.",
  availability:
    "Open to full-stack, frontend, and backend roles across India · Available immediately",
  ...
  coreStack:
    "TypeScript · JavaScript · React · Node.js · Express · Prisma · Supabase · PostgreSQL · Docker · Flutter",

  about:
    "I'm a 2024 Computer Science graduate and early-career software engineer. My experience includes frontend development with React and TypeScript, full-stack builds with Node.js and PostgreSQL, and mobile development with Flutter. I care about typed code, clear documentation, practical testing, and building applications that are production-ready. I'm passionate about solving real problems — not just building demos.",
  ...
  projects: [
    ...
    },
    {
      ...
      engineering: [
        ...
        "99% feature parity across all plans — everything is free",
      ],
    },
    {
      name: "SS Mart POS",
      ...
      features: [
        ...
        "Reference data import — HSN/SAC, PIN, IFSC CSVs",
        "Works on phones and tablets — slide-out nav below desktop width",
        "Customer directory — visit counts, total spend, loyalty balances",
        ...
        "Zero external calls at runtime — fully self-contained",
      ],
      engineering: [
        ...
        "Linux-only USB passthrough, Windows/mobile use browser print",
      ],
    },
    {
      name: "SS Mart ERP",
      summary:
        "Complete retail ERP/POS system with Flutter mobile/desktop client, .NET 8 backend API, and PostgreSQL database. Offline-first architecture with background synchronization — designed for Indian retail operations with GST, HSN/SAC, and B2B/B2C support. Includes billing, inventory, purchase management, CRM, loyalty points, employee management, shift management, and 9-phase roadmap.",
  ...
  contactCopy:
    "I'm available immediately for full-stack, frontend, backend/API, and software engineering opportunities. Let's discuss how I can help build production-ready applications for your team.",

  // CMS-backed data placeholder — content editable via admin dashboard
  // 7 sections: profile, projects, experience, education, skills, navigation, contact
  // stored in Supabase portfolio_sections table with RLS policies
} as const;